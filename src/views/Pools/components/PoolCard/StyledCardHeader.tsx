...
import { CardHeader, Heading, Text, Flex, Image } from '@xdcx/smiley-uikit'
...
const StyledCardHeader: React.FC<{
  ...
  const isCakePool = earningTokenSymbol === 'SMS' && stakingTokenSymbol === 'SMS'
